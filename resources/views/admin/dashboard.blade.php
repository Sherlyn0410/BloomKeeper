        ...
        <div class="mx-auto flex min-h-screen max-w-[1500px] gap-6 p-4 sm:p-6">
            ...
            <main class="min-w-0 flex-1">
                <header class="flex items-center justify-between gap-4 px-1 py-2 sm:px-3">
                    ...
                    <div class="flex gap-3"><a href="{{ route('admin.operations') }}" class="rounded-full bg-[#285443] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#1f4435]">Operations</a><a href="{{ route('admin.users.index') }}" class="rounded-full bg-[#e3953d] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#d47f2a]">Manage users</a></div>
                </header>
